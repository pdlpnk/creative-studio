---
id: CG-0014
name: "Benefit-First Information Card — TR registration"
geo: TR
funnel: registration
language: tr
...
generation_key: "TR|registration|benefit-first information card|green,white|bell|minimal card grid with one primary action"
novelty_score: 91
similarity_to_existing: {"id": "CC-0004", "score": 0.09}
colors: ["green", "white"]
objects: ["bell"]
...
- Objects: bell
- Composition: minimal card grid with one primary action
- Direction: benefit-first information card; one dominant headline and one primary action.
...
- Closest existing card: CC-0004 (0.09)
